...
window.onload = function init() {
    ...
    document.getElementById("Button2").onclick = function(){theta += dr;console.log("theta: "+theta);};
    document.getElementById("Button3").onclick = function(){theta -= dr;console.log("theta: "+theta);};
    document.getElementById("Button4").onclick = function(){phi += dr;console.log("phi: "+phi);};
    document.getElementById("Button5").onclick = function(){phi -= dr;console.log("phi: "+phi);};
    document.getElementById("Button6").onclick = function(){phi = 0;theta = 0;console.log("phi: "+phi+"\ntheta: "+theta);};
